...
function component.Init(components_)
	...
	-- LFG Button (right side, mirroring map button position)
	instance.lfgButton = CreateFrame("Button", nil, instance)
	instance.lfgButton:SetSize(32, 32)
	instance.lfgButton:SetPoint("BOTTOMRIGHT", -45, 126)  -- Mirrored position from map button
	...
	-- Shadow/background (same style as map button)
	...
	instance.lfgButton.shadow:SetPoint("CENTER", 0, 5)
	instance.lfgButton.shadow:SetSize(100, 40)
	-- Icon
	...
	instance.lfgButton.icon:SetSize(28, 28)
	instance.lfgButton.icon:SetPoint("CENTER")
	-- Highlight
