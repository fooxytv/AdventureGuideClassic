...
InstanceService.AddRaid({
	...
	overview = "",
	{
		...
		encounterID = 12118,
		portrait = 1378993,
		loot = {{ id = 16800, seasonFilter = "all" }, { id = 16829, seasonFilter = "all" }, { id = 16837, seasonFilter = "all" }, { id = 16859, seasonFilter = "all" }, { id = 16805, seasonFilter = "all" }, { id = 16863, seasonFilter = "all" }, { id = 17109, seasonFilter = "all" }, { id = 16665, seasonFilter = "all" }},
		sharedLoot = {{ id = 17077, seasonFilter = "all" }, { id = 18861, seasonFilter = "all" }, { id = 18879, seasonFilter = "all" }, { id = 18870, seasonFilter = "all" }, { id = 18872, seasonFilter = "all" }, { id = 19147, seasonFilter = "all" }, { id = 19145, seasonFilter = "all" }, { id = 18875, seasonFilter = "all" }, { id = 18878, seasonFilter = "all" }, { id = 19146, seasonFilter = "all" }},
		rareLoot = {{ }},
		veryRareLoot = {{ }},
		extremelyRareLoot = {{ }},
	...
	},
	{
		...
		encounterID = 11982,
		portrait = 1378995,
		loot = {{ id = 16835, seasonFilter = "all" }, { id = 16847, seasonFilter = "all" }, { id = 16796, seasonFilter = "all" }, { id = 16855, seasonFilter = "all" }, { id = 16814, seasonFilter = "all" }, { id = 16822, seasonFilter = "all" }, { id = 16843, seasonFilter = "all" }, { id = 16810, seasonFilter = "all" }, { id = 16867, seasonFilter = "all" }, { id = 17073, seasonFilter = "all" }, { id = 18203, seasonFilter = "all" }, { id = 17065, seasonFilter = "all" }, { id = 17069, seasonFilter = "all" }, { id = 18260, seasonFilter = "all" }},
		sharedLoot = {{ id = 17077, seasonFilter = "all" }, { id = 18861, seasonFilter = "all" }, { id = 18879, seasonFilter = "all" }, { id = 18870, seasonFilter = "all" }, { id = 18872, seasonFilter = "all" }, { id = 19147, seasonFilter = "all" }, { id = 19145, seasonFilter = "all" }, { id = 18875, seasonFilter = "all" }, { id = 18878, seasonFilter = "all" }, { id = 19146, seasonFilter = "all" }},
		rareLoot = {{ }},
		veryRareLoot = {{ }},
		extremelyRareLoot = {{ }},
	...
	},
	{
		...
		encounterID = 12259,
		portrait = 1378976,
		loot = {{ id = 16849, seasonFilter = "all" }, { id = 16860, seasonFilter = "all" }, { id = 16812, seasonFilter = "all" }, { id = 16826, seasonFilter = "all" }, { id = 16839, seasonFilter = "all" }, { id = 16862, seasonFilter = "all" }},
		sharedLoot = {{ id = 17077, seasonFilter = "all" }, { id = 18861, seasonFilter = "all" }, { id = 18879, seasonFilter = "all" }, { id = 18870, seasonFilter = "all" }, { id = 18872, seasonFilter = "all" }, { id = 19147, seasonFilter = "all" }, { id = 19145, seasonFilter = "all" }, { id = 18875, seasonFilter = "all" }, { id = 18878, seasonFilter = "all" }, { id = 19146, seasonFilter = "all" }},
		rareLoot = { },
		veryRareLoot = { },
		extremelyRareLoot = { },
	...
	},
	{
		...
		encounterID = 12057,
		portrait = 1378975,
		loot = {{ id = 16834, seasonFilter = "all" }, { id = 16846, seasonFilter = "all" }, { id = 16795, seasonFilter = "all" }, { id = 16854, seasonFilter = "all" }, { id = 16813, seasonFilter = "all" }, { id = 16821, seasonFilter = "all" }, { id = 16842, seasonFilter = "all" }, { id = 16808, seasonFilter = "all" }, { id = 16866, seasonFilter = "all" }, { id = 17105, seasonFilter = "all" }, { id = 18832, seasonFilter = "all" }, { id = 17066, seasonFilter = "all" }, { id = 17071, seasonFilter = "all" }},
		sharedLoot = {{ id = 18823, seasonFilter = "all" }, { id = 18829, seasonFilter = "all" }, { id = 19142, seasonFilter = "all" }, { id = 19143, seasonFilter = "all" }, { id = 18861, seasonFilter = "all" }, { id = 18824, seasonFilter = "all" }, { id = 19136, seasonFilter = "all" }, { id = 18822, seasonFilter = "all" }, { id = 18821, seasonFilter = "all" }, { id = 19144, seasonFilter = "all" }, { id = 18820, seasonFilter = "all" }},
		rareLoot = {{ id = 18564, seasonFilter = "all" }},
		veryRareLoot = {{ }},
		extremelyRareLoot = {{ }},
		npcs = { 2135, 12456, 12314 },
		overview = {
	...
	},
	{
		...
		encounterID = 12264,
		portrait = 1379013,
		loot = {{ id = 16831, seasonFilter = "all" }, { id = 16852, seasonFilter = "all" }, { id = 16801, seasonFilter = "all" }, { id = 16811, seasonFilter = "all" }, { id = 16824, seasonFilter = "all" }, { id = 16803, seasonFilter = "all" }},
		sharedLoot = {{ id = 17077, seasonFilter = "all" }, { id = 18861, seasonFilter = "all" }, { id = 18879, seasonFilter = "all" }, { id = 18870, seasonFilter = "all" }, { id = 18872, seasonFilter = "all" }, { id = 19147, seasonFilter = "all" }, { id = 19145, seasonFilter = "all" }, { id = 18875, seasonFilter = "all" }, { id = 18878, seasonFilter = "all" }, { id = 19146, seasonFilter = "all" }},
		rareLoot = {{ }},
		veryRareLoot = {{ }},
		extremelyRareLoot = {{ }},
	...
	},
	{
		...
		encounterID = 12056,
		portrait = 1378966,
		loot = {{ id = 16836, seasonFilter = "all" }, { id = 16797, seasonFilter = "all" }, { id = 16856, seasonFilter = "all" }, { id = 16844, seasonFilter = "all" }, { id = 16807, seasonFilter = "all" }, { id = 17110, seasonFilter = "all" }},
		sharedLoot = {{ id = 17077, seasonFilter = "all" }, { id = 18861, seasonFilter = "all" }, { id = 18879, seasonFilter = "all" }, { id = 18870, seasonFilter = "all" }, { id = 18872, seasonFilter = "all" }, { id = 19147, seasonFilter = "all" }, { id = 19145, seasonFilter = "all" }, { id = 18875, seasonFilter = "all" }, { id = 18878, seasonFilter = "all" }, { id = 19146, seasonFilter = "all" }},
		rareLoot = {{ id = 18563, seasonFilter = "all" }},
		veryRareLoot = {{ }},
		extremelyRareLoot = {{ }},
		npcs = { 2135, 12456, 12314 },
		overview = {
	...
	},
	{
		...
		encounterID = 11988,
		portrait = 1378978,
		loot = {{ id = 16833, seasonFilter = "all" }, { id = 16845, seasonFilter = "all" }, { id = 16798, seasonFilter = "all" }, { id = 16853, seasonFilter = "all" }, { id = 16815, seasonFilter = "all" }, { id = 16820, seasonFilter = "all" }, { id = 16841, seasonFilter = "all" }, { id = 16809, seasonFilter = "all" }, { id = 16865, seasonFilter = "all" }, { id = 17203, seasonFilter = "all" }, { id = 17103, seasonFilter = "all" }, { id = 17072, seasonFilter = "all" }, { id = 18842, seasonFilter = "all" }},
		sharedLoot = {{ id = 18823, seasonFilter = "all" }, { id = 18829, seasonFilter = "all" }, { id = 19142, seasonFilter = "all" }, { id = 19143, seasonFilter = "all" }, { id = 18861, seasonFilter = "all" }, { id = 18824, seasonFilter = "all" }, { id = 19136, seasonFilter = "all" }, { id = 18822, seasonFilter = "all" }, { id = 18821, seasonFilter = "all" }, { id = 19144, seasonFilter = "all" }, { id = 18820, seasonFilter = "all" }},
		rareLoot = {{ }},
		veryRareLoot = {{ }},
		extremelyRareLoot = {{ }},
	...
	},
	{
		...
		encounterID = 12098,
		portrait = 1379015,
		loot = {{ id = 16848, seasonFilter = "all" }, { id = 16816, seasonFilter = "all" }, { id = 16823, seasonFilter = "all" }, { id = 16868, seasonFilter = "all" }, { id = 17074, seasonFilter = "all" }},
		sharedLoot = {{ id = 17077, seasonFilter = "all" }, { id = 18861, seasonFilter = "all" }, { id = 18879, seasonFilter = "all" }, { id = 18870, seasonFilter = "all" }, { id = 18872, seasonFilter = "all" }, { id = 19147, seasonFilter = "all" }, { id = 19145, seasonFilter = "all" }, { id = 18875, seasonFilter = "all" }, { id = 18878, seasonFilter = "all" }, { id = 19146, seasonFilter = "all" }},
		rareLoot = {{ }},
		veryRareLoot = {{ }},
		extremelyRareLoot = {{ }},
	...
	},
	{
		...
		encounterID = 12018,
		portrait = 1378998,
		loot = {{ id = 18703, seasonFilter = "all" }, { id = 18646, seasonFilter = "all" }, { id = 19140, seasonFilter = "all" }, { id = 18806, seasonFilter = "all" }, { id = 18805, seasonFilter = "all" }, { id = 18803, seasonFilter = "all" }, { id = 19139, seasonFilter = "all" }, { id = 18811, seasonFilter = "all" }, { id = 18808, seasonFilter = "all" }, { id = 18809, seasonFilter = "all" }, { id = 18810, seasonFilter = "all" }, { id = 18812, seasonFilter = "all" }}
,		sharedLoot = {{ }},
		rareLoot = {{ }},
		veryRareLoot = {{ }},
		extremelyRareLoot = {{ }},
	...
	},
	{
		...
		encounterID = 11502,
		portrait = 522261,
		loot = {{ id = 16915, seasonFilter = "all" }, { id = 16901, seasonFilter = "all" }, { id = 16946, seasonFilter = "all" }, { id = 16954, seasonFilter = "all" }, { id = 16930, seasonFilter = "all" }, { id = 16962, seasonFilter = "all" }, { id = 16938, seasonFilter = "all" }, { id = 16922, seasonFilter = "all" }, { id = 16909, seasonFilter = "all" }, { id = 18816, seasonFilter = "all" }, { id = 19138, seasonFilter = "all" }, { id = 18817, seasonFilter = "all" }, { id = 17063, seasonFilter = "all" }, { id = 17107, seasonFilter = "all" }, { id = 18815, seasonFilter = "all" }, { id = 18814, seasonFilter = "all" }, { id = 17102, seasonFilter = "all" }, { id = 17106, seasonFilter = "all" }, { id = 19137, seasonFilter = "all" }, { id = 17082, seasonFilter = "all" }, { id = 17104, seasonFilter = "all" }, { id = 17076, seasonFilter = "all" }, { id = 17204, seasonFilter = "all" }}
,		sharedLoot = {{ }},
		rareLoot = {{ }},
		veryRareLoot = {{ }},
		extremelyRareLoot = {{ }},
