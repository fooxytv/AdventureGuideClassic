 ...
 InstanceService.AddRaid({
	...
	},
	{
		...
		loot = {
			...
			{ id = 34839, seasonFilter = "tbc" },
			{ id = 34840, seasonFilter = "tbc" },
			{ id = 34841, seasonFilter = "tbc" },
			{ id = 34842, seasonFilter = "tbc" },
			{ id = 34843, seasonFilter = "tbc" }
		},
		sharedLoot = {
			{ id = 35285, seasonFilter = "tbc" },
			{ id = 35286, seasonFilter = "tbc" },
			{ id = 35287, seasonFilter = "tbc" }
		},
		rareLoot = {},
		veryRareLoot = {},
		extremelyRareLoot = {},
	...
	},
	{
		...
		portrait = 607673,
		loot = {
			{ id = 34845, seasonFilter = "tbc" },
			{ id = 34846, seasonFilter = "tbc" },
			{ id = 34847, seasonFilter = "tbc" },
			{ id = 34854, seasonFilter = "tbc" },
			{ id = 34855, seasonFilter = "tbc" },
			{ id = 34857, seasonFilter = "tbc" },
			{ id = 34858, seasonFilter = "tbc" }
		...
		sharedLoot = {
			{ id = 35288, seasonFilter = "tbc" },
			{ id = 35289, seasonFilter = "tbc" },
	...
	},
	{
		...
		portrait = 1390438,
		loot = {
			{ id = 34861, seasonFilter = "tbc" },
			{ id = 34862, seasonFilter = "tbc" },
			{ id = 34863, seasonFilter = "tbc" },
			{ id = 34864, seasonFilter = "tbc" },
			{ id = 34865, seasonFilter = "tbc" },
			{ id = 34866, seasonFilter = "tbc" },
			{ id = 34867, seasonFilter = "tbc" }
		},
		sharedLoot = {
			{ id = 35291, seasonFilter = "tbc" },
			{ id = 35292, seasonFilter = "tbc" },
			{ id = 35293, seasonFilter = "tbc" }
		},
		rareLoot = {},
		veryRareLoot = {},
		extremelyRareLoot = {},
	...
	},
	{
		...
		portrait = 1385757,
		loot = {
			{ id = 34869, seasonFilter = "tbc" },
			{ id = 34870, seasonFilter = "tbc" },
			{ id = 34871, seasonFilter = "tbc" },
			{ id = 34872, seasonFilter = "tbc" },
			{ id = 34873, seasonFilter = "tbc" },
			{ id = 34874, seasonFilter = "tbc" }
		},
		sharedLoot = {
			{ id = 35294, seasonFilter = "tbc" },
			{ id = 35295, seasonFilter = "tbc" },
			{ id = 35296, seasonFilter = "tbc" }
		},
		rareLoot = {},
		veryRareLoot = {},
		extremelyRareLoot = {},
	...
	},
	{
		...
		sharedLoot = {
			{ id = 35297, seasonFilter = "tbc" },
			{ id = 35298, seasonFilter = "tbc" },
			{ id = 35299, seasonFilter = "tbc" }
		},
		rareLoot = {
