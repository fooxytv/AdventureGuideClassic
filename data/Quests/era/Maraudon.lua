...
QuestService.Register("Maraudon", {
	...
	{ id = 7041, name = "Vyletongue Corruption", level = 47, minLevel = 41, side = "Alliance", startedBy = "Talendria", startZone = "Desolace", startedById = 11715, startedByDisplay = 11683, rewards = { 17768, 17770, 17778 } },
	{ id = 7067, name = "The Pariah's Instructions", level = 48, minLevel = 39, startedBy = "Centaur Pariah", startZone = "Desolace", startedById = 13717, startedByDisplay = 9419, rewards = { 17774 } },
	{ id = 7044, name = "Legends of Maraudon", level = 49, minLevel = 41, startedBy = "Cavindra", startZone = "Desolace", startedById = 13697, startedByDisplay = 14425 },
