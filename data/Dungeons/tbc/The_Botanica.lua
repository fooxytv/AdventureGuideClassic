...
select(2, ...).SetupGlobalFacade()
 ...
 InstanceService.AddDungeon({
	...
	overview = "The Botanica is a massive bio-dome satellite of Tempest Keep, where blood elf botanists conduct experiments to create a sustainable food source for their people. High Botanist Freywinn has used these facilities to mutate and weaponize the plant life, creating an army of aggressive botanical creatures.",
	{
		...
		portrait = 607570,
		loot = {
			{ id = 24131, seasonFilter = "all" },
			{ id = 24138, seasonFilter = "all" },
			{ id = 24141, seasonFilter = "all" },
			{ id = 28311, seasonFilter = "all" },
			{ id = 28304, seasonFilter = "all" },
			{ id = 28306, seasonFilter = "all" },
			{ id = 28301, seasonFilter = "all" },
			{ id = 28296, seasonFilter = "all" }
		},
		sharedLoot = {
			{ id = 24150, seasonFilter = "all" },
			{ id = 24151, seasonFilter = "all" },
			{ id = 24152, seasonFilter = "all" },
			{ id = 24153, seasonFilter = "all" },
			{ id = 24154, seasonFilter = "all" }
		},
		rareLoot = {},
		veryRareLoot = {},
		extremelyRareLoot = {},
	...
	},
	{
		...
		portrait = 607641,
		loot = {
			{ id = 24121, seasonFilter = "all" },
			{ id = 24122, seasonFilter = "all" },
			{ id = 24119, seasonFilter = "all" },
			{ id = 24120, seasonFilter = "all" },
			{ id = 28315, seasonFilter = "all" },
			{ id = 28321, seasonFilter = "all" },
			{ id = 28316, seasonFilter = "all" },
			{ id = 28312, seasonFilter = "all" }
		},
		sharedLoot = {
			{ id = 24150, seasonFilter = "all" },
			{ id = 24151, seasonFilter = "all" },
	...
	},
	{
		...
		portrait = 607794,
		loot = {
			{ id = 24124, seasonFilter = "all" },
			{ id = 24125, seasonFilter = "all" },
			{ id = 24126, seasonFilter = "all" },
			{ id = 24127, seasonFilter = "all" },
			{ id = 28324, seasonFilter = "all" },
			{ id = 28325, seasonFilter = "all" },
			{ id = 28323, seasonFilter = "all" },
			{ id = 28322, seasonFilter = "all" }
		},
		sharedLoot = {
			{ id = 24150, seasonFilter = "all" },
			{ id = 24151, seasonFilter = "all" },
	...
	},
	{
		...
		portrait = 607714,
		loot = {
			{ id = 27739, seasonFilter = "all" },
			{ id = 27740, seasonFilter = "all" },
			{ id = 27741, seasonFilter = "all" },
			{ id = 27742, seasonFilter = "all" },
			{ id = 28339, seasonFilter = "all" },
			{ id = 28340, seasonFilter = "all" },
			{ id = 28338, seasonFilter = "all" },
			{ id = 28337, seasonFilter = "all" }
		},
		sharedLoot = {
			{ id = 24150, seasonFilter = "all" },
			{ id = 24151, seasonFilter = "all" },
	...
	},
	{
		...
		portrait = 607816,
		loot = {
			{ id = 24128, seasonFilter = "all" },
			{ id = 24129, seasonFilter = "all" },
			{ id = 24130, seasonFilter = "all" },
			{ id = 28342, seasonFilter = "all" },
			{ id = 28345, seasonFilter = "all" },
			{ id = 28347, seasonFilter = "all" },
			{ id = 28348, seasonFilter = "all" },
			{ id = 28341, seasonFilter = "all" },
			{ id = 29362, seasonFilter = "all" }
		},
		sharedLoot = {
			{ id = 24150, seasonFilter = "all" },
			{ id = 24151, seasonFilter = "all" },
