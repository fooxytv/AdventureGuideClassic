...
select(2, ...).SetupGlobalFacade()
 ...
 InstanceService.AddDungeon({
	...
	overview = "The Slave Pens are the holding cells of Coilfang Reservoir, where the naga imprison those they've captured in their campaign to drain the marshes of Zangarmarsh. Slaves are forced to labor in the pumping stations, extracting the precious water to create a new ocean for Lady Vashj.",
	{
		...
		portrait = 607715,
		loot = {
			{ id = 24359, seasonFilter = "tbc" },
			{ id = 24357, seasonFilter = "tbc" },
			{ id = 24360, seasonFilter = "tbc" },
			{ id = 24356, seasonFilter = "tbc" },
			{ id = 24361, seasonFilter = "tbc" },
			{ id = 27542, seasonFilter = "tbc" },
			{ id = 27545, seasonFilter = "tbc" },
			{ id = 27541, seasonFilter = "tbc" },
			{ id = 27546, seasonFilter = "tbc" },
			{ id = 27544, seasonFilter = "tbc" },
			{ id = 27543, seasonFilter = "tbc" }
		},
		sharedLoot = {},
		rareLoot = {},
		veryRareLoot = {},
	...
	},
	{
		...
		portrait = 607759,
		loot = {
			{ id = 24379, seasonFilter = "tbc" },
			{ id = 24376, seasonFilter = "tbc" },
			{ id = 24378, seasonFilter = "tbc" },
			{ id = 24380, seasonFilter = "tbc" },
			{ id = 24381, seasonFilter = "tbc" },
			{ id = 27550, seasonFilter = "tbc" },
			{ id = 27547, seasonFilter = "tbc" },
			{ id = 28124, seasonFilter = "tbc" },
			{ id = 27549, seasonFilter = "tbc" },
			{ id = 27548, seasonFilter = "tbc" },
			{ id = 27551, seasonFilter = "tbc" }
		},
		sharedLoot = {},
		rareLoot = {},
		veryRareLoot = {},
	...
	},
	{
		...
		portrait = 607750,
		loot = {
			{ id = 24362, seasonFilter = "tbc" },
			{ id = 24365, seasonFilter = "tbc" },
			{ id = 24366, seasonFilter = "tbc" },
			{ id = 24363, seasonFilter = "tbc" },
			{ id = 24364, seasonFilter = "tbc" },
			{ id = 29242, seasonFilter = "tbc" },
			{ id = 30538, seasonFilter = "tbc" },
			{ id = 32078, seasonFilter = "tbc" },
			{ id = 29349, seasonFilter = "tbc" },
			{ id = 27712, seasonFilter = "tbc" },
			{ id = 27800, seasonFilter = "tbc" },
			{ id = 28337, seasonFilter = "tbc" },
			{ id = 27672, seasonFilter = "tbc" },
			{ id = 27742, seasonFilter = "tbc" },
			{ id = 27796, seasonFilter = "tbc" },
			{ id = 27713, seasonFilter = "tbc" },
			{ id = 27740, seasonFilter = "tbc" },
			{ id = 27683, seasonFilter = "tbc" },
			{ id = 27714, seasonFilter = "tbc" },
			{ id = 27673, seasonFilter = "tbc" },
			{ id = 27741, seasonFilter = "tbc" }
		},
		sharedLoot = {},
		rareLoot = {},
		veryRareLoot = {},
