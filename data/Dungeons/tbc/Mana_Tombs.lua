...
InstanceService.AddDungeon({
	...
	overview = "The Mana-Tombs are the burial grounds for the exiled Ethereals who were killed during the destruction of Outland. Now the Shadow Council has invaded, using the site to siphon arcane energy from the remains of the fallen ethereals.",
	{
		...
		portrait = 607738,
		loot = {
			{ id = 25941, seasonFilter = "tbc" },
			{ id = 25942, seasonFilter = "tbc" },
			{ id = 25940, seasonFilter = "tbc" },
			{ id = 25943, seasonFilter = "tbc" },
			{ id = 28166, seasonFilter = "tbc" },
			{ id = 25939, seasonFilter = "tbc" },
			{ id = 27816, seasonFilter = "tbc" },
			{ id = 27818, seasonFilter = "tbc" },
			{ id = 27813, seasonFilter = "tbc" },
			{ id = 27815, seasonFilter = "tbc" },
			{ id = 27814, seasonFilter = "tbc" },
			{ id = 27817, seasonFilter = "tbc" }
		},
		sharedLoot = {},
		rareLoot = {},
		veryRareLoot = {},
	...
	},
	{
		...
		portrait = 607782,
		loot = {
			{ id = 25945, seasonFilter = "tbc" },
			{ id = 25946, seasonFilter = "tbc" },
			{ id = 25947, seasonFilter = "tbc" },
			{ id = 25952, seasonFilter = "tbc" },
			{ id = 25944, seasonFilter = "tbc" },
			{ id = 25950, seasonFilter = "tbc" },
			{ id = 27824, seasonFilter = "tbc" },
			{ id = 27821, seasonFilter = "tbc" },
			{ id = 27825, seasonFilter = "tbc" },
			{ id = 27826, seasonFilter = "tbc" },
			{ id = 27823, seasonFilter = "tbc" },
			{ id = 27822, seasonFilter = "tbc" }
		},
		sharedLoot = {},
		rareLoot = {},
		veryRareLoot = {},
	...
	},
	{
		...
		portrait = 607726,
		loot = {
			{ id = 25957, seasonFilter = "tbc" },
			{ id = 25955, seasonFilter = "tbc" },
			{ id = 25956, seasonFilter = "tbc" },
			{ id = 25954, seasonFilter = "tbc" },
			{ id = 25962, seasonFilter = "tbc" },
			{ id = 25953, seasonFilter = "tbc" },
			{ id = 29240, seasonFilter = "tbc" },
			{ id = 30535, seasonFilter = "tbc" },
			{ id = 29352, seasonFilter = "tbc" },
			{ id = 32082, seasonFilter = "tbc" },
			{ id = 27831, seasonFilter = "tbc" },
			{ id = 27843, seasonFilter = "tbc" },
			{ id = 27827, seasonFilter = "tbc" },
			{ id = 27835, seasonFilter = "tbc" },
			{ id = 27844, seasonFilter = "tbc" },
			{ id = 27798, seasonFilter = "tbc" },
			{ id = 27837, seasonFilter = "tbc" },
			{ id = 27828, seasonFilter = "tbc" },
			{ id = 28400, seasonFilter = "tbc" },
			{ id = 27829, seasonFilter = "tbc" },
			{ id = 27840, seasonFilter = "tbc" },
			{ id = 27842, seasonFilter = "tbc" }
		},
		sharedLoot = {},
		rareLoot = {},
		veryRareLoot = {},
