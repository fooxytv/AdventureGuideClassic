...
InstanceService.AddDungeon({
	...
	overview = "Auchenai Crypts is a sacred burial ground in the Bone Wastes of Terokkar Forest. Once a peaceful resting place for draenei dead, it has been corrupted by the Shadow Council. Death cultists now perform dark rituals within, raising the dead to serve their masters.",
	{
		...
		portrait = 607771,
		loot = {
			{ id = 27410, seasonFilter = "tbc" },
			{ id = 27409, seasonFilter = "tbc" },
			{ id = 27408, seasonFilter = "tbc" },
			{ id = 26055, seasonFilter = "tbc" },
			{ id = 25964, seasonFilter = "tbc" },
			{ id = 27866, seasonFilter = "tbc" },
			{ id = 27493, seasonFilter = "tbc" },
			{ id = 27865, seasonFilter = "tbc" },
			{ id = 27845, seasonFilter = "tbc" },
			{ id = 27847, seasonFilter = "tbc" },
			{ id = 27846, seasonFilter = "tbc" }
		},
		sharedLoot = {},
		rareLoot = {},
		veryRareLoot = {},
	...
	},
	{
		...
		portrait = 607600,
		loot = {
			{ id = 27411, seasonFilter = "tbc" },
			{ id = 27415, seasonFilter = "tbc" },
			{ id = 27414, seasonFilter = "tbc" },
			{ id = 27413, seasonFilter = "tbc" },
			{ id = 27416, seasonFilter = "tbc" },
			{ id = 27412, seasonFilter = "tbc" },
			{ id = 21525, seasonFilter = "tbc" },
			{ id = 29354, seasonFilter = "tbc" },
			{ id = 29257, seasonFilter = "tbc" },
			{ id = 29244, seasonFilter = "tbc" },
			{ id = 27867, seasonFilter = "tbc" },
			{ id = 27871, seasonFilter = "tbc" },
			{ id = 27869, seasonFilter = "tbc" },
			{ id = 27523, seasonFilter = "tbc" },
			{ id = 27872, seasonFilter = "tbc" },
			{ id = 27870, seasonFilter = "tbc" }
		},
		sharedLoot = {},
		rareLoot = {},
		veryRareLoot = {},
