...
select(2, ...).SetupGlobalFacade()
 ...
 InstanceService.AddDungeon({
	...
	overview = "The Underbog is a festering marsh beneath Coilfang Reservoir, where the naga's drainage operations have exposed ancient bog creatures to the surface. The once-peaceful marsh has become a breeding ground for aggressive fungi and beasts, all corrupted by the naga's dark influence.",
	{
		...
		portrait = 607649,
		loot = {
			{ id = 24450, seasonFilter = "tbc" },
			{ id = 24452, seasonFilter = "tbc" },
			{ id = 24451, seasonFilter = "tbc" },
			{ id = 24413, seasonFilter = "tbc" },
			{ id = 27631, seasonFilter = "tbc" },
			{ id = 27746, seasonFilter = "tbc" },
			{ id = 27745, seasonFilter = "tbc" },
			{ id = 27743, seasonFilter = "tbc" },
			{ id = 27748, seasonFilter = "tbc" },
			{ id = 27744, seasonFilter = "tbc" },
			{ id = 27747, seasonFilter = "tbc" }
		},
		sharedLoot = {},
		rareLoot = {},
		veryRareLoot = {},
	...
	},
	{
		...
		portrait = 607614,
		loot = {
			{ id = 24459, seasonFilter = "tbc" },
			{ id = 24458, seasonFilter = "tbc" },
			{ id = 24460, seasonFilter = "tbc" },
			{ id = 24462, seasonFilter = "tbc" },
			{ id = 24461, seasonFilter = "tbc" },
			{ id = 27760, seasonFilter = "tbc" },
			{ id = 27759, seasonFilter = "tbc" },
			{ id = 27755, seasonFilter = "tbc" },
			{ id = 27758, seasonFilter = "tbc" },
			{ id = 27761, seasonFilter = "tbc" },
			{ id = 27757, seasonFilter = "tbc" }
		},
		sharedLoot = {},
		rareLoot = {},
		veryRareLoot = {},
	...
	},
	{
		...
		portrait = 607779,
		loot = {
			{ id = 24454, seasonFilter = "tbc" },
			{ id = 24455, seasonFilter = "tbc" },
			{ id = 24457, seasonFilter = "tbc" },
			{ id = 24456, seasonFilter = "tbc" },
			{ id = 24453, seasonFilter = "tbc" },
			{ id = 27764, seasonFilter = "tbc" },
			{ id = 27763, seasonFilter = "tbc" },
			{ id = 27765, seasonFilter = "tbc" },
			{ id = 27766, seasonFilter = "tbc" },
			{ id = 27762, seasonFilter = "tbc" },
			{ id = 27767, seasonFilter = "tbc" }
		},
		sharedLoot = {},
		rareLoot = {},
		veryRareLoot = {},
	...
	},
	{
		...
		portrait = 607788,
		loot = {
			{ id = 24481, seasonFilter = "tbc" },
			{ id = 24466, seasonFilter = "tbc" },
			{ id = 24465, seasonFilter = "tbc" },
			{ id = 24463, seasonFilter = "tbc" },
			{ id = 24464, seasonFilter = "tbc" },
			{ id = 29265, seasonFilter = "tbc" },
			{ id = 30541, seasonFilter = "tbc" },
			{ id = 32081, seasonFilter = "tbc" },
			{ id = 29350, seasonFilter = "tbc" },
			{ id = 27781, seasonFilter = "tbc" },
			{ id = 27768, seasonFilter = "tbc" },
			{ id = 27938, seasonFilter = "tbc" },
			{ id = 27773, seasonFilter = "tbc" },
			{ id = 27779, seasonFilter = "tbc" },
			{ id = 27780, seasonFilter = "tbc" },
			{ id = 27896, seasonFilter = "tbc" },
			{ id = 27770, seasonFilter = "tbc" },
			{ id = 27907, seasonFilter = "tbc" },
			{ id = 27771, seasonFilter = "tbc" },
			{ id = 27769, seasonFilter = "tbc" },
			{ id = 27772, seasonFilter = "tbc" }
		},
		sharedLoot = {},
		rareLoot = {},
		veryRareLoot = {},
