...
InstanceService.AddDungeon({
	...
	overview = "Hellfire Ramparts is the first wing of Hellfire Citadel, a massive fortress in the Hellfire Peninsula. Once a proud bastion of the draenei, it has been corrupted by the fel magic of the Burning Legion. Now the ramparts serve as a training ground for the Fel Horde's warriors. Adventurers must breach these defenses to weaken the Legion's hold on Outland.",
	{
		...
		portrait = 607817,
		loot = {
			{ id = 24024, seasonFilter = "tbc" },
			{ id = 24023, seasonFilter = "tbc" },
			{ id = 24022, seasonFilter = "tbc" },
			{ id = 24021, seasonFilter = "tbc" },
			{ id = 24020, seasonFilter = "tbc" },
			{ id = 27448, seasonFilter = "tbc" },
			{ id = 27451, seasonFilter = "tbc" },
			{ id = 27450, seasonFilter = "tbc" },
			{ id = 27447, seasonFilter = "tbc" },
			{ id = 27449, seasonFilter = "tbc" }
		},
		sharedLoot = {},
		rareLoot = {},
		veryRareLoot = {},
	...
	},
	{
		...
		portrait = 607734,
		loot = {
			{ id = 24090, seasonFilter = "tbc" },
			{ id = 24091, seasonFilter = "tbc" },
			{ id = 24073, seasonFilter = "tbc" },
			{ id = 24096, seasonFilter = "tbc" },
			{ id = 24094, seasonFilter = "tbc" },
			{ id = 24069, seasonFilter = "tbc" },
			{ id = 27466, seasonFilter = "tbc" },
			{ id = 27462, seasonFilter = "tbc" },
			{ id = 27467, seasonFilter = "tbc" },
			{ id = 27478, seasonFilter = "tbc" },
			{ id = 27539, seasonFilter = "tbc" },
			{ id = 27906, seasonFilter = "tbc" },
			{ id = 27464, seasonFilter = "tbc" },
			{ id = 27895, seasonFilter = "tbc" },
			{ id = 27477, seasonFilter = "tbc" },
			{ id = 27463, seasonFilter = "tbc" },
			{ id = 27476, seasonFilter = "tbc" },
			{ id = 27465, seasonFilter = "tbc" }
		},
		sharedLoot = {},
		rareLoot = {},
		veryRareLoot = {},
	...
	},
	{
		...
		portrait = 607812,
		loot = {
			{ id = 24150, seasonFilter = "tbc" },
			{ id = 24083, seasonFilter = "tbc" },
			{ id = 24063, seasonFilter = "tbc" },
			{ id = 24046, seasonFilter = "tbc" },
			{ id = 24064, seasonFilter = "tbc" },
			{ id = 24045, seasonFilter = "tbc" },
			{ id = 24154, seasonFilter = "tbc" },
			{ id = 24151, seasonFilter = "tbc" },
			{ id = 24044, seasonFilter = "tbc" },
			{ id = 24155, seasonFilter = "tbc" },
			{ id = 29264, seasonFilter = "tbc" },
			{ id = 32077, seasonFilter = "tbc" },
			{ id = 29238, seasonFilter = "tbc" },
			{ id = 29346, seasonFilter = "tbc" },
			{ id = 27452, seasonFilter = "tbc" },
			{ id = 27461, seasonFilter = "tbc" },
			{ id = 27456, seasonFilter = "tbc" },
			{ id = 27454, seasonFilter = "tbc" },
			{ id = 27458, seasonFilter = "tbc" },
			{ id = 27455, seasonFilter = "tbc" },
			{ id = 27459, seasonFilter = "tbc" },
			{ id = 27457, seasonFilter = "tbc" },
			{ id = 27453, seasonFilter = "tbc" },
			{ id = 27460, seasonFilter = "tbc" }
		},
		sharedLoot = {},
		rareLoot = {},
		veryRareLoot = {},
