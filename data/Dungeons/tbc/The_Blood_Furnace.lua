...
select(2, ...).SetupGlobalFacade()
 ...
 InstanceService.AddDungeon({
	...
	overview = "The Blood Furnace is the heart of the fel orc operation in Hellfire Citadel. Here, Kargath Bladefist oversees the creation of fel orcs, forcing captives to drink the blood of the pit lord Magtheridon. The furnace serves as both a prison and a factory for Illidan's army.",
	{
		...
		portrait = 607789,
		loot = {
			{ id = 24384, seasonFilter = "tbc", difficulty = "normal" },
			{ id = 24388, seasonFilter = "tbc", difficulty = "normal" },
			{ id = 24387, seasonFilter = "tbc", difficulty = "normal" },
			{ id = 24385, seasonFilter = "tbc", difficulty = "normal" },
			{ id = 27487, seasonFilter = "tbc", difficulty = "heroic" },
			{ id = 27485, seasonFilter = "tbc", difficulty = "heroic" },
			{ id = 27488, seasonFilter = "tbc", difficulty = "heroic" },
			{ id = 27483, seasonFilter = "tbc", difficulty = "heroic" },
		},
		sharedLoot = {},
		rareLoot = {},
		veryRareLoot = {},
	...
	},
	{
		...
		portrait = 607558,
		loot = {
			{ id = 24392, seasonFilter = "tbc", difficulty = "normal" },
			{ id = 24390, seasonFilter = "tbc", difficulty = "normal" },
			{ id = 24393, seasonFilter = "tbc", difficulty = "normal" },
			{ id = 24391, seasonFilter = "tbc", difficulty = "normal" },
			{ id = 24389, seasonFilter = "tbc", difficulty = "normal" },
			{ id = 27848, seasonFilter = "tbc", difficulty = "heroic" },
			{ id = 27490, seasonFilter = "tbc", difficulty = "heroic" },
			{ id = 27492, seasonFilter = "tbc", difficulty = "heroic" },
			{ id = 27491, seasonFilter = "tbc", difficulty = "heroic" },
			{ id = 27489, seasonFilter = "tbc", difficulty = "heroic" },
		},
		sharedLoot = {},
		rareLoot = {},
		veryRareLoot = {},
	...
	},
	{
		...
		portrait = 607670,
		loot = {
			{ id = 24398, seasonFilter = "tbc", difficulty = "normal" },
			{ id = 24395, seasonFilter = "tbc", difficulty = "normal" },
			{ id = 24397, seasonFilter = "tbc", difficulty = "normal" },
			{ id = 24394, seasonFilter = "tbc", difficulty = "normal" },
			{ id = 24396, seasonFilter = "tbc", difficulty = "normal" },
			{ id = 29239, seasonFilter = "tbc", difficulty = "heroic" },
			{ id = 32080, seasonFilter = "tbc", difficulty = "heroic" },
			{ id = 29347, seasonFilter = "tbc", difficulty = "heroic" },
			{ id = 29245, seasonFilter = "tbc", difficulty = "heroic" },
			{ id = 27507, seasonFilter = "tbc", difficulty = "heroic" },
			{ id = 27788, seasonFilter = "tbc", difficulty = "heroic" },
			{ id = 27497, seasonFilter = "tbc", difficulty = "heroic" },
			{ id = 27494, seasonFilter = "tbc", difficulty = "heroic" },
			{ id = 28121, seasonFilter = "tbc", difficulty = "heroic" },
			{ id = 27514, seasonFilter = "tbc", difficulty = "heroic" },
			{ id = 27506, seasonFilter = "tbc", difficulty = "heroic" },
			{ id = 27505, seasonFilter = "tbc", difficulty = "heroic" },
			{ id = 27495, seasonFilter = "tbc", difficulty = "heroic" },
			{ id = 27512, seasonFilter = "tbc", difficulty = "heroic" },
			{ id = 28264, seasonFilter = "tbc", difficulty = "heroic" },
			{ id = 27522, seasonFilter = "tbc", difficulty = "heroic" },
			{ id = 33814, seasonFilter = "tbc", difficulty = "heroic" },
		},
		sharedLoot = {},
		rareLoot = {},
		veryRareLoot = {},
