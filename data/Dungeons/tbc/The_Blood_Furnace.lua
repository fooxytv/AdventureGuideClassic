...
select(2, ...).SetupGlobalFacade()
 ...
 InstanceService.AddDungeon({
	...
	overview = "The Blood Furnace is the heart of the fel orc operation in Hellfire Citadel. Here, Kargath Bladefist oversees the creation of fel orcs, forcing captives to drink the blood of the pit lord Magtheridon. The furnace serves as both a prison and a factory for Illidan's army.",
	{
		...
		portrait = 607789,
		loot = {
			{ id = 24384, seasonFilter = "all" },
			{ id = 24385, seasonFilter = "all" },
			{ id = 24386, seasonFilter = "all" },
			{ id = 24387, seasonFilter = "all" },
			{ id = 24388, seasonFilter = "all" },
			{ id = 27483, seasonFilter = "all" },
			{ id = 27484, seasonFilter = "all" },
			{ id = 27485, seasonFilter = "all" },
			{ id = 27487, seasonFilter = "all" },
			{ id = 27488, seasonFilter = "all" }
		},
		sharedLoot = {},
		rareLoot = {},
		veryRareLoot = {},
	...
	},
	{
		...
		portrait = 607558,
		loot = {
			{ id = 24389, seasonFilter = "all" },
			{ id = 24390, seasonFilter = "all" },
			{ id = 24391, seasonFilter = "all" },
			{ id = 24392, seasonFilter = "all" },
			{ id = 24393, seasonFilter = "all" },
			{ id = 27489, seasonFilter = "all" },
			{ id = 27490, seasonFilter = "all" },
			{ id = 27491, seasonFilter = "all" },
			{ id = 27492, seasonFilter = "all" },
			{ id = 27848, seasonFilter = "all" }
		},
		sharedLoot = {},
		rareLoot = {},
		veryRareLoot = {},
	...
	},
	{
		...
		portrait = 607670,
		loot = {
			{ id = 24394, seasonFilter = "all" },
			{ id = 24395, seasonFilter = "all" },
			{ id = 24396, seasonFilter = "all" },
			{ id = 24397, seasonFilter = "all" },
			{ id = 24398, seasonFilter = "all" },
			{ id = 27494, seasonFilter = "all" },
			{ id = 27495, seasonFilter = "all" },
			{ id = 27497, seasonFilter = "all" },
			{ id = 27505, seasonFilter = "all" },
			{ id = 27506, seasonFilter = "all" },
			{ id = 27507, seasonFilter = "all" },
			{ id = 27512, seasonFilter = "all" },
			{ id = 27514, seasonFilter = "all" },
			{ id = 27522, seasonFilter = "all" },
			{ id = 27788, seasonFilter = "all" },
			{ id = 28121, seasonFilter = "all" },
			{ id = 28264, seasonFilter = "all" },
			{ id = 29239, seasonFilter = "all" },
			{ id = 29245, seasonFilter = "all" },
			{ id = 29347, seasonFilter = "all" },
			{ id = 32080, seasonFilter = "all" }
		},
		sharedLoot = {},
		rareLoot = {},
		veryRareLoot = {},
