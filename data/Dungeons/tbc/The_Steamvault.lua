...
InstanceService.AddDungeon({
	...
	overview = "The Steamvault is the main pumping facility of Coilfang Reservoir, a massive network of underground pipes and chambers built by the naga. Here, enormous pumps work ceaselessly to drain the lakes of Zangarmarsh. The hydromancer Thespia has been corrupted by dark magic while overseeing operations.",
	{
		...
		portrait = 607651,
		loot = {
			{ id = 27787, seasonFilter = "tbc" },
			{ id = 27789, seasonFilter = "tbc" },
			{ id = 27508, seasonFilter = "tbc" },
			{ id = 27783, seasonFilter = "tbc" },
			{ id = 27784, seasonFilter = "tbc" },
			{ id = 29673, seasonFilter = "tbc" },
		},
		sharedLoot = {},
		rareLoot = {},
		veryRareLoot = {},
	...
	},
	{
		...
		portrait = 607713,
		loot = {
			{ id = 27793, seasonFilter = "tbc" },
			{ id = 27790, seasonFilter = "tbc" },
			{ id = 27794, seasonFilter = "tbc" },
			{ id = 23887, seasonFilter = "tbc" },
			{ id = 27791, seasonFilter = "tbc" },
			{ id = 27792, seasonFilter = "tbc" },
		},
		sharedLoot = {},
		rareLoot = {},
		veryRareLoot = {},
	...
	},
	{
		...
		portrait = 607815,
		loot = {
			{ id = 24313, seasonFilter = "tbc" },
			{ id = 27874, seasonFilter = "tbc" },
			{ id = 27801, seasonFilter = "tbc" },
			{ id = 28203, seasonFilter = "tbc" },
			{ id = 27804, seasonFilter = "tbc" },
			{ id = 27806, seasonFilter = "tbc" },
			{ id = 27475, seasonFilter = "tbc" },
			{ id = 27738, seasonFilter = "tbc" },
			{ id = 27737, seasonFilter = "tbc" },
			{ id = 27805, seasonFilter = "tbc" },
			{ id = 27795, seasonFilter = "tbc" },
			{ id = 27510, seasonFilter = "tbc" },
			{ id = 27799, seasonFilter = "tbc" },
			{ id = 29463, seasonFilter = "tbc", difficulty = "heroic" },
			{ id = 30543, seasonFilter = "tbc", difficulty = "heroic" },
			{ id = 29243, seasonFilter = "tbc", difficulty = "heroic" },
			{ id = 29351, seasonFilter = "tbc", difficulty = "heroic" },
			{ id = 31721, seasonFilter = "tbc", difficulty = "heroic" },
			{ id = 33827, seasonFilter = "tbc", difficulty = "heroic" },
		},
		sharedLoot = {},
		rareLoot = {},
		veryRareLoot = {},
