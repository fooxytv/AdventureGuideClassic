...
InstanceService.AddDungeon({
	...
	overview = "Legends state that where the demigod Agamaggan fell, his blood gave rise to great masses of thorny vines. Recently, scouts have reported seeing undead milling about the region, engendering fears that the dreaded Scourge may be moving to conquer Kalimdor.",
	{
		...
		portrait = 607799,
		loot = {
			{ id = 10775, seasonFilter = "all" },
			{ id = 10776, seasonFilter = "all" },
			{ id = 10777, seasonFilter = "all" },
		},
		sharedLoot = {},
		rareLoot = {},
		veryRareLoot = {},
	...
	},
	{
		...
		loot = {
			{ id = 10760, seasonFilter = "all" },
			{ id = 10766, seasonFilter = "all" },
		},
		sharedLoot = {},
		rareLoot = {},
		veryRareLoot = {},
	...
	},
	{
		...
		portrait = 607718,
		loot = {
			{ id = 10769, seasonFilter = "all" },
			{ id = 10770, seasonFilter = "all" },
			{ id = 10771, seasonFilter = "all" },
		},
		sharedLoot = {},
		rareLoot = {},
		veryRareLoot = {},
	...
	},
	{
		...
		loot = {
			{ id = 10767, seasonFilter = "all" },
			{ id = 10768, seasonFilter = "all" },
			{ id = 10758, seasonFilter = "all" },
		},
		sharedLoot = {},
		rareLoot = {},
		veryRareLoot = {},
	...
	},
	{
		...
		portrait = 607617,
		loot = {
			{ id = 10772, seasonFilter = "all" },
			{ id = 10774, seasonFilter = "all" },
		},
		sharedLoot = {},
		rareLoot = {},
		veryRareLoot = {},
	...
	},
	{
		...
		portrait = 607537,
		loot = {
			{ id = 10761, seasonFilter = "all" },
			{ id = 10763, seasonFilter = "all" },
			{ id = 10764, seasonFilter = "all" },
			{ id = 10762, seasonFilter = "all" },
			{ id = 10765, seasonFilter = "all" },
		},
		sharedLoot = {},
		rareLoot = {},
		veryRareLoot = {},
