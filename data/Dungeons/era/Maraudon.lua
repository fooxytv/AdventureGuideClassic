...
InstanceService.AddDungeon({
	...
	overview = "According to legend, Zaetar, son of Cenarius, and the earth elemental princess Theradras begot the barbaric centaur race. Shortly after the centaur's creation, the ruthless creatures murdered their father. The grief-stricken Theradras is said to have trapped her lover's spirit within Maraudon, corrupting the region. Now, vicious centaur ghosts and twisted elemental minions roam every corner of the sprawling caves.",
	{
		...
		portrait = 607728,
		loot = {
			{ id = 17744, seasonFilter = "all" },
			{ id = 17745, seasonFilter = "all" },
			{ id = 17746, seasonFilter = "all" },
		},
		sharedLoot = {},
		rareLoot = {},
		veryRareLoot = {},
	...
	},
	{
		...
		portrait = 607756,
		loot = {
			{ id = 17749, seasonFilter = "all" },
			{ id = 17748, seasonFilter = "all" },
			{ id = 17751, seasonFilter = "all" },
			{ id = 17750, seasonFilter = "all" },
		},
		sharedLoot = {},
		rareLoot = {},
		veryRareLoot = {},
	...
	},
	{
		...
		portrait = 607699,
		loot = {
			{ id = 17754, seasonFilter = "all" },
			{ id = 17752, seasonFilter = "all" },
			{ id = 17755, seasonFilter = "all" },
		},
		sharedLoot = {},
		rareLoot = {},
		veryRareLoot = {},
	...
	},
	{
		...
		portrait = 607562,
		loot = {
			{ id = 17738, seasonFilter = "all" },
			{ id = 17739, seasonFilter = "all" },
			{ id = 17740, seasonFilter = "all" },
		},
		sharedLoot = {},
		rareLoot = {},
		veryRareLoot = {},
	...
	},
	{
		...
		portrait = 607684,
		loot = {
			{ id = 17737, seasonFilter = "all" },
			{ id = 17943, seasonFilter = "all" },
			{ id = 17734, seasonFilter = "all" },
			{ id = 17736, seasonFilter = "all" },
		},
		sharedLoot = {},
		rareLoot = {},
		veryRareLoot = {},
	...
	},
	{
		...
		portrait = 607796,
		loot = {
			{ id = 17718, seasonFilter = "all" },
			{ id = 17719, seasonFilter = "all" },
			{ id = 17717, seasonFilter = "all" },
		},
		sharedLoot = {},
		rareLoot = {},
		veryRareLoot = {},
	...
	},
	{
		...
		portrait = 607761,
		loot = {
			{ id = 17728, seasonFilter = "all" },
			{ id = 17730, seasonFilter = "all" },
			{ id = 17732, seasonFilter = "all" },
		},
		sharedLoot = {},
		rareLoot = {},
		veryRareLoot = {},
	...
	},
	{
		...
		portrait = 607747,
		loot = {
			{ id = 17713, seasonFilter = "all" },
			{ id = 17714, seasonFilter = "all" },
			{ id = 17710, seasonFilter = "all" },
			{ id = 17711, seasonFilter = "all" },
			{ id = 17715, seasonFilter = "all" },
			{ id = 17707, seasonFilter = "all" },
			{ id = 17766, seasonFilter = "all" },
		},
		sharedLoot = {},
		rareLoot = {},
		veryRareLoot = {
			{ id = 223964, seasonFilter = "exclusive" },
			{ id = 17780, seasonFilter = "restricted" },
		},
		extremelyRareLoot = {},
		overview = {
