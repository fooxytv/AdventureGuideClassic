...
InstanceService.AddDungeon({
	...
	overview = "The smoldering Blackrock Depths are home to the Dark Iron dwarves and their emperor, Dagran Thaurissan. Like his predecessors, he serves under the iron rule of Ragnaros the Firelord, a merciless being summoned into the world centuries ago. The presence of chaotic elementals has attracted Twilight's Hammer cultists to the mountain domain. Along with Ragnaros' servants, they have pushed the dwarves toward increasingly destructive ends that could soon spell doom for all of Azeroth.",
	{
		...
		portrait = 607697,
		loot = {
			{ id = 22397, seasonFilter = "all" },
			{ id = 22234, seasonFilter = "all" },
			{ id = 11631, seasonFilter = "all" },
			{ id = 11632, seasonFilter = "all" }
		},
		sharedLoot = {},
		rareLoot = {},
		veryRareLoot = {},
	...
	},
	{
		...
		portrait = 607549,
		loot = {
			{ id = 11802, seasonFilter = "all" },
			{ id = 11803, seasonFilter = "all" },
			{ id = 11805, seasonFilter = "all" },
			{ id = 11807, seasonFilter = "all" }
		},
		sharedLoot = {},
		rareLoot = {},
		veryRareLoot = {},
	...
	},
	{
		...
		portrait = 607647,
		loot = {
			{ id = 11623, seasonFilter = "all" },
			{ id = 11629, seasonFilter = "all" },
			{ id = 11628, seasonFilter = "all" },
			{ id = 11627, seasonFilter = "all" }
		},
		sharedLoot = {},
		rareLoot = {},
		veryRareLoot = {},
	...
	},
	{
		...
		portrait = 607644,
		loot = {
			{ id = 22240, seasonFilter = "all" },
			{ id = 11626, seasonFilter = "all" },
			{ id = 11625, seasonFilter = "all" },
			{ id = 11624, seasonFilter = "all" }
		},
		sharedLoot = {},
		rareLoot = {},
		veryRareLoot = {},
	...
	},
	{
		...
		portrait = 608314,
		loot = {
			{ id = 11726, seasonFilter = "all" },
			{ id = 22271, seasonFilter = "all" },
			{ id = 22266, seasonFilter = "all" },
			{ id = 22257, seasonFilter = "all" },
			{ id = 22270, seasonFilter = "all" },
			{ id = 11722, seasonFilter = "all" },
			{ id = 11703, seasonFilter = "all" },
			{ id = 11702, seasonFilter = "all" },
			{ id = 11730, seasonFilter = "all" },
			{ id = 11679, seasonFilter = "all" },
			{ id = 11685, seasonFilter = "all" },
			{ id = 11686, seasonFilter = "all" },
			{ id = 11728, seasonFilter = "all" },
			{ id = 11662, seasonFilter = "all" },
			{ id = 11665, seasonFilter = "all" },
			{ id = 11824, seasonFilter = "all" },
			{ id = 11731, seasonFilter = "all" },
			{ id = 11675, seasonFilter = "all" },
			{ id = 11677, seasonFilter = "all" },
			{ id = 11678, seasonFilter = "all" },
			{ id = 11729, seasonFilter = "all" },
			{ id = 11633, seasonFilter = "all" },
			{ id = 11634, seasonFilter = "all" },
			{ id = 11635, seasonFilter = "all" }
		},
		sharedLoot = {},
		rareLoot = {},
		veryRareLoot = {},
	...
	},
	{
		...
		portrait = 607749,
		loot = {
			{ id = 11750, seasonFilter = "all" },
			{ id = 11749, seasonFilter = "all" },
			{ id = 11748, seasonFilter = "all" },
			{ id = 11747, seasonFilter = "all" }
		},
		sharedLoot = {},
		rareLoot = {},
		veryRareLoot = {},
	...
	},
	{
		...
		portrait = 607610,
		loot = {
			{ id = 11816, seasonFilter = "all" },
			{ id = 11817, seasonFilter = "all" },
			{ id = 11820, seasonFilter = "all" },
			{ id = 11821, seasonFilter = "all" },
			{ id = 11810, seasonFilter = "all" }
		},
		sharedLoot = {},
		rareLoot = {},
		veryRareLoot = {},
	...
	},
	{
		...
		portrait = 607618,
		loot = {
			{ id = 11669, seasonFilter = "all" },
			{ id = 11819, seasonFilter = "all" },
			{ id = 11822, seasonFilter = "all" },
			{ id = 11823, seasonFilter = "all" }
		},
		sharedLoot = {},
		rareLoot = {},
		veryRareLoot = {},
	...
	},
	{
		...
		portrait = 607758,
		loot = {
			{ id = 11742, seasonFilter = "all" },
			{ id = 2663, seasonFilter = "all" },
			{ id = 2662, seasonFilter = "all" }
		},
		sharedLoot = {},
		rareLoot = {},
		veryRareLoot = {},
		extremelyRareLoot = {},
		npcs = { 9537, 12944, 9543, 9499 },
		overview = {
	...
	},
	{
		...
		portrait = 607650,
		loot = {
			{ id = 22275, seasonFilter = "all" },
			{ id = 18044, seasonFilter = "all" },
			{ id = 18043, seasonFilter = "all" }
		},
		sharedLoot = {},
		rareLoot = {},
		veryRareLoot = {},
	...
	},
	{
		...
		portrait = 607741,
		loot = {
			{ id = 12791, seasonFilter = "all" },
			{ id = 12793, seasonFilter = "all" }
		},
		sharedLoot = {},
		rareLoot = {},
		veryRareLoot = {},
	...
	},
	{
		...
		portrait = 607740,
		loot = {
			{ id = 22212, seasonFilter = "all" },
			{ id = 11744, seasonFilter = "all" },
			{ id = 11745, seasonFilter = "all" },
			{ id = 11743, seasonFilter = "all" }
		},
		sharedLoot = {},
		rareLoot = {},
		veryRareLoot = {},
	...
	},
	{
		...
		portrait = 607694,
		loot = {
			{ id = 11764, seasonFilter = "all" },
			{ id = 11765, seasonFilter = "all" },
			{ id = 11766, seasonFilter = "all" },
			{ id = 11767, seasonFilter = "all" }
		},
		sharedLoot = {},
		rareLoot = {},
		veryRareLoot = {},
	...
	},
	{
		...
		portrait = 607602,
		loot = {
			{ id = 22223, seasonFilter = "all" },
			{ id = 11839, seasonFilter = "all" },
			{ id = 11841, seasonFilter = "all" },
			{ id = 11842, seasonFilter = "all" }
		},
		sharedLoot = {},
		rareLoot = {},
		veryRareLoot = {},
	...
	},
	{
		...
		portrait = 607814,
		loot = {
			{ id = 22241, seasonFilter = "all" },
			{ id = 11784, seasonFilter = "all" },
			{ id = 11783, seasonFilter = "all" },
			{ id = 11782, seasonFilter = "all" },
			{ id = 22242, seasonFilter = "all" },
			{ id = 11755, seasonFilter = "all" }
		},
		sharedLoot = {},
		rareLoot = {},
		veryRareLoot = {},
	...
	},
	{
		...
		portrait = 607535,
		loot = {
			{ id = 11809, seasonFilter = "all" },
			{ id = 11812, seasonFilter = "all" },
			{ id = 11814, seasonFilter = "all" },
			{ id = 11832, seasonFilter = "all" }
		},
		sharedLoot = {},
		rareLoot = {},
		veryRareLoot = {
			{ id = 227973, seasonFilter = "exclusive" },
			{ id = 11808, seasonFilter = "restricted" }
		},
		extremelyRareLoot = {},
		npcs = { 9156 },
		overview = {
	...
	},
	{
		...
		portrait = 607636,
		loot = {
			{ id = 11920, seasonFilter = "all" },
			{ id = 11921, seasonFilter = "all" },
			{ id = 11922, seasonFilter = "all" },
			{ id = 11923, seasonFilter = "all" },
			{ id = 11925, seasonFilter = "all" },
			{ id = 11926, seasonFilter = "all" },
			{ id = 11927, seasonFilter = "all" },
			{ id = 11929, seasonFilter = "all" }
		},
		sharedLoot = {},
		rareLoot = {},
		veryRareLoot = {},
	...
	},
	{
		...
		portrait = 607705,
		loot = {
			{ id = 11746, seasonFilter = "all" },
			{ id = 22400, seasonFilter = "all" },
			{ id = 22395, seasonFilter = "all" },
			{ id = 22208, seasonFilter = "all" },
			{ id = 11935, seasonFilter = "all" }
		},
		sharedLoot = {},
		rareLoot = {},
		veryRareLoot = {},
	...
	},
	{
		...
		portrait = 607595,
		loot = {
			{ id = 22204, seasonFilter = "all" },
			{ id = 22207, seasonFilter = "all" },
			{ id = 11815, seasonFilter = "all" },
			{ id = 12557, seasonFilter = "all" },
			{ id = 11924, seasonFilter = "all" },
			{ id = 11928, seasonFilter = "all" },
			{ id = 11932, seasonFilter = "all" },
			{ id = 11934, seasonFilter = "all" },
			{ id = 11930, seasonFilter = "all" },
			{ id = 11933, seasonFilter = "all" },
			{ id = 11931, seasonFilter = "all" },
			{ id = 12553, seasonFilter = "all" },
			{ id = 12556, seasonFilter = "all" },
			{ id = 12554, seasonFilter = "all" }
		},
		sharedLoot = {},
		rareLoot = {},
		veryRareLoot = {
			{ id = 227991, seasonFilter = "exclusive" },
			{ id = 11684, seasonFilter = "restricted" }
		},
		extremelyRareLoot = {},
		npcs = { 9019 },
		overview = {
