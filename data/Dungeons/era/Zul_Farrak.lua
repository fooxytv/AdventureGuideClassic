...
InstanceService.AddDungeon({
	...
	overview = "Zul'Farrak was once the shining jewel of Tanaris, ferociously protected by the cunning Sandfury tribe. Despite the trolls' tenacity, this isolated group was forced to surrender much of its territory throughout history. Now, it appears that Zul'Farrak's inhabitants are creating a horrific army of undead trolls to conquer the surrounding region. Other disturbing rumors tell of an ancient creature sleeping within the city--one that, if awakened, will rain death and destruction across Tanaris.",
	{
		...
		portrait = 607541,
		loot = {
			{ id = 9641, seasonFilter = "all" },
			{ id = 9379, seasonFilter = "all" },
			{ id = 9639, seasonFilter = "all" },
			{ id = 9640, seasonFilter = "all" },
		},
		sharedLoot = {},
		rareLoot = {},
		veryRareLoot = {},
	...
	},
	{
		...
		portrait = 607819,
		loot = {
			{ id = 18083, seasonFilter = "all" },
			{ id = 18082, seasonFilter = "all" },
		},
		sharedLoot = {},
		rareLoot = {},
		veryRareLoot = {},
	...
	-- },
	{
		...
		portrait = 607770,
		loot = {
			{ id = 9470, seasonFilter = "all" },
			{ id = 9475, seasonFilter = "all" },
			{ id = 9474, seasonFilter = "all" },
			{ id = 9473, seasonFilter = "all" },
		},
		sharedLoot = {},
		rareLoot = {},
		veryRareLoot = {},
	...
	},
	{
		...
		portrait = 607564,
		loot = {
			{ id = 9476, seasonFilter = "all" },
			{ id = 9479, seasonFilter = "all" },
			{ id = 11086, seasonFilter = "all" },
			{ id = 9478, seasonFilter = "all" },
			{ id = 9477, seasonFilter = "all" },
		},
		sharedLoot = {},
		rareLoot = {},
		veryRareLoot = {},
