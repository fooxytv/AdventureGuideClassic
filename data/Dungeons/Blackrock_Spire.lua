	...
	overview = "This imposing fortress, carved into the fiery core of Blackrock Mountain, represented the might of the Dark Iron clan for centuries. More recently, the black dragon Nefarian and his spawn seized the keep's upper spire and ignited a brutal war against the dwarves. The draconic armies have since allied with Warchief Rend Blackhand and his false Horde. This combined force lords over the spire, conducting horrific experiments to bolster its ranks while plotting the meddlesome Dark Irons' downfall.",
		{
			...
			encounterID = 9196,
			portrait = 607645,
			loot = {{ id = 16670, seasonFilter = "all" }, { id = 13167, seasonFilter = "all" }, { id = 13170, seasonFilter = "all" }, { id = 13166, seasonFilter = "all" }, { id = 13169, seasonFilter = "all" }},
			sharedLoot = {{ }},
			rareLoot = {{ }},
			veryRareLoot = {{ }},
			extremelyRareLoot = {{ }},
		...
		},
		{
			...
			encounterID = 9236,
			portrait = 607769,
			loot = {{ id = 12651, seasonFilter = "all" }, { id = 13257, seasonFilter = "all" }, { id = 12626, seasonFilter = "all" }, { id = 12653, seasonFilter = "all" }, { id = 16712, seasonFilter = "all" }, { id = 13255, seasonFilter = "all" }},
			sharedLoot = {{ }},
			rareLoot = {{ }},
			veryRareLoot = {{ }},
			extremelyRareLoot = {{ }},
		...
		},
		{
			...
			encounterID = 9237,
			portrait = 607810,
			loot = {{ id = 16676, seasonFilter = "all" }, { id = 13179, seasonFilter = "all" }, { id = 12582, seasonFilter = "all" }, { id = 13177, seasonFilter = "all" }, { id = 13175, seasonFilter = "all" }},
			sharedLoot = {{ }},
			rareLoot = {{ }},
			veryRareLoot = {{ }},
			extremelyRareLoot = {{ }},
		...
		},
		{
			...
			encounterID = 10596,
			portrait = 607719,
			loot = {{ id = 13244, seasonFilter = "all" }, { id = 13213, seasonFilter = "all" }, { id = 13183, seasonFilter = "all" }, { id = 16715, seasonFilter = "all" }},
			sharedLoot = {{ }},
			rareLoot = {{ }},
			veryRareLoot = {{ }},
			extremelyRareLoot = {{ }},
		...
		},
		{
			...
			encounterID = 10584,
			portrait = 607801,
			loot = {{ id = 13178, seasonFilter = "all" }, { id = 22232, seasonFilter = "all" }, { id = 13259, seasonFilter = "all" }, { id = 13258, seasonFilter = "all" }},
			sharedLoot = {{ }},
			rareLoot = {{ }},
			veryRareLoot = {{ }},
			extremelyRareLoot = {{ }},
		...
		},
		{
			...
			encounterID = 9736,
			portrait = 607751,
			loot = {{ id = 13252, seasonFilter = "all" }, { id = 13253, seasonFilter = "all" }},
			sharedLoot = {{ }},
			rareLoot = {{ }},
			veryRareLoot = {{ }},
			extremelyRareLoot = {{ }},
		...
		},
		{
			...
			encounterID = 10220,
			portrait = 607634,
			loot = {{ id = 22313, seasonFilter = "all" }, { id = 13212, seasonFilter = "all" }, { id = 13210, seasonFilter = "all" }, { id = 13211, seasonFilter = "all" }},
			sharedLoot = {{ }},
			rareLoot = {{ }},
			veryRareLoot = {{ }},
			extremelyRareLoot = {{ }},
		...
		},
		{
			...
			encounterID = 10268,
			portrait = 607615,
			loot = {{ id = 13208, seasonFilter = "all" }, { id = 13205, seasonFilter = "all" }, { id = 16718, seasonFilter = "all" }, { id = 13206, seasonFilter = "all" }},
			sharedLoot = {{ }},
			rareLoot = {{ }},
			veryRareLoot = {{ }},
			extremelyRareLoot = {{ }},
		...
		},
		{
			...
			encounterID = 9568,
			portrait = 607737,
			loot = {{ id = 22321, seasonFilter = "all" }, { id = 16679, seasonFilter = "all" }, { id = 13148, seasonFilter = "all" }, { id = 13164, seasonFilter = "all" }, { id = 13162, seasonFilter = "all" }, { id = 13163, seasonFilter = "all" }, { id = 13161, seasonFilter = "all" }},
			sharedLoot = {{ }},
			rareLoot = {{ }},
			veryRareLoot = {{ id = 228585, seasonFilter = "exclusive" }, { id = 13143, seasonFilter = "restricted" }
			},
			extremelyRareLoot = {{ }},
			npcs = { 9568 },
			overview = {
		...
		},
		{
			...
			encounterID = 9816,
			portrait = 607748,
			loot = {{ id = 12905, seasonFilter = "all" }, { id = 12926, seasonFilter = "all" }, { id = 12927, seasonFilter = "all" }, { id = 12929, seasonFilter = "all" }, { id = 16672, seasonFilter = "all" }},
			sharedLoot = {{ }},
			rareLoot = {{ }},
			veryRareLoot = {{ }},
			extremelyRareLoot = {{ }},
		...
		},
		{
			...
			encounterID = 9816,
			portrait = 607737,
			loot = {{ id = 12606, seasonFilter = "all" }, { id = 12589, seasonFilter = "all" }, { id = 12603, seasonFilter = "all" }, { id = 12609, seasonFilter = "all" }, { id = 16695, seasonFilter = "all" }},
			sharedLoot = {{ }},
			rareLoot = {{ }},
			veryRareLoot = {{ }},
			extremelyRareLoot = {{ }},
		...
		},
		{
			...
			loot = {{ id = 13498, seasonFilter = "all" }, { id = 13502, seasonFilter = "all" }, { id = 18047, seasonFilter = "all" }, { id = 18048, seasonFilter = "all" }},
			sharedLoot = {{ }},
			rareLoot = {{ }},
			veryRareLoot = {{ }},
			extremelyRareLoot = {{ }},
		...
		},
		{
			...
			encounterID = 10429,
			portrait = 607813,
			loot = {{ id = 22225, seasonFilter = "all" }, { id = 12952, seasonFilter = "all" }, { id = 12953, seasonFilter = "all" }, { id = 12960, seasonFilter = "all" }, { id = 16669, seasonFilter = "all" }, { id = 22247, seasonFilter = "all" }, { id = 12587, seasonFilter = "all" }, { id = 12935, seasonFilter = "all" }, { id = 18102, seasonFilter = "all" }, { id = 18103, seasonFilter = "all" }, { id = 12936, seasonFilter = "all" }, { id = 16733, seasonFilter = "all" }, { id = 18104, seasonFilter = "all" }, { id = 12583, seasonFilter = "all" }, { id = 12940, seasonFilter = "all" }, { id = 12939, seasonFilter = "all" }},
			sharedLoot = {{ }},
			rareLoot = {{ }},
			veryRareLoot = {{ id = 228757, seasonFilter = "exclusive" }, { id = 12590, seasonFilter = "restricted" }},
			extremelyRareLoot = {{ }},
			npcs = { 10429, 10339 },
			overview = {
		...
		},
		{
			...
			encounterID = 10430,
			portrait = 607786,
			loot = {{ id = 22311, seasonFilter = "all" }, { id = 12709, seasonFilter = "all" }, { id = 12963, seasonFilter = "all" }, { id = 12964, seasonFilter = "all" }, { id = 12965, seasonFilter = "all" }, { id = 12966, seasonFilter = "all" }, { id = 12967, seasonFilter = "all" }, { id = 12968, seasonFilter = "all" }, { id = 12969, seasonFilter = "all" }, { id = 16729, seasonFilter = "all" }},
			sharedLoot = {{ }},
			rareLoot = {{ }},
			veryRareLoot = {{ }},
			extremelyRareLoot = {{ }},
		...
		},
		{
			...
			encounterID = 10363,
			portrait = 607612,
			loot = {{ id = 22267, seasonFilter = "all" }, { id = 22269, seasonFilter = "all" }, { id = 22268, seasonFilter = "all" }, { id = 22253, seasonFilter = "all" }, { id = 12602, seasonFilter = "all" }, { id = 13098, seasonFilter = "all" }, { id = 13141, seasonFilter = "all" }, { id = 13142, seasonFilter = "all" }, { id = 16666, seasonFilter = "all" }, { id = 16674, seasonFilter = "all" }, { id = 16688, seasonFilter = "all" }, { id = 16690, seasonFilter = "all" }, { id = 16700, seasonFilter = "all" }, { id = 16706, seasonFilter = "all" }, { id = 16721, seasonFilter = "all" }, { id = 16726, seasonFilter = "all" }, { id = 16730, seasonFilter = "all" }},
			sharedLoot = {{ }},
			rareLoot = {{ }},
			veryRareLoot = {{ id = 228606, seasonFilter = "exclusive" }, { id = 12592, seasonFilter = "restricted" }},
			extremelyRareLoot = {{ }},
			npcs = { 10363 },
			overview = {
